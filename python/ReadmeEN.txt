...
2. Pin connection:
You can check the pin connection at Pico_CapTouch_ePaper_Test_xxx.py, and repeat it here:
EPD    =>    Pico
VCC    ->    VSYS
GND    ->    GND
DIN    ->    11
...
3. Basic use:
    ...
    5): Open the python/Pico_CapTouch_ePaper_Test_xxx.py file in Thonny IDE
